<!--画面一覧とは矛盾しますがh11は保護者が購入履歴を確認するページにします-->
<!DOCTYPE html>
<html>
<head>
    <meta charset='utf-8'>
    ...
    <title>h11_purchase_history.html</title>
    <script>
        /*----------------------------------------------------------------------*/
        /* sp_nav_menu
        /*----------------------------------------------------------------------*/
    ...
    <div class="wrap">
        ...
        <div class="sort_area">
            <select name="example">
                ...
                <option value="2">はやおくん</option>
                <option value="3">けいたくん</option>
                <option value="3">まもるくん</option>
                <option value="3">りょうくん</option>
            </select>
            <div class="sort_btn"><a href="#">50音順</a></div>
            <div class="sort_btn"><a href="#">アルファベット順</a></div>
            <div class="sort_btn"><a href="#">高い順</a></div>
            <div class="sort_btn"><a href="#">安い順 </a></div>
            <div class="sort_btn"><a href="#">新しい順</a></div>
            <div class="sort_btn"><a href="#">古い順</a></div>
        </div>
